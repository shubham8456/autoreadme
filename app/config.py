...
DEFAULT_OUTPUT = os.getenv("AUTOREADME_OUTPUT", "README.generated.md")
OLLAMA_URL = os.getenv("AUTOREADME_OLLAMA_URL", "http://127.0.0.1:11434")
MAX_FILE_BYTES = int(os.getenv("AUTOREADME_MAX_FILE_BYTES", str(128 * 1024)))
MAX_FILES = int(os.getenv("AUTOREADME_MAX_FILES", "80"))
